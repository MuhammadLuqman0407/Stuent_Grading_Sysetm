...
A modern, interactive web application for managing and visualizing student grades. Built with HTML5, CSS3, JavaScript, and Bootstrap 5.

## 📋 Features

- **Load Data**: Import student records from JSON or XML files
- **Merge Data**: Combine multiple data sources seamlessly
